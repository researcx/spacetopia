...
/obj/decal/lunar_bootprint
	...
	attack_hand(mob/user as mob)
		...
		user.visible_message("<b>[user]</b> steps right into [src.name].", "<span style=\"color:orange\">You step into the footprint. Ha ha, oh man, your foot fits right into that!</span>")
