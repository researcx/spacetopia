...
/obj/machinery/networked/telepad
	...
	attack_hand(mob/user as mob)
		...
		var/dat = "<html><head><title>Telepad</title>[css_interfaces]</head><body>"
...
/obj/machinery/networked/teleconsole
	...
	attack_hand(var/mob/user as mob)
		...
		var/dat = "<head><TITLE>Teleport Computer</TITLE>[css_interfaces]</head><body><br>"
		if (!host_id)
	...
	{
		document.getElementById("readout").innerHTML = "[css_interfaces]<TT>" + t + "</tt>";
	}
	</script>"}
