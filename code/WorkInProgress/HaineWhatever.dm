...
*/
	...
	attack_hand(mob/user as mob)
		...
		if (src.active)
			...
			src.activate()
		message_admins("<span style=\"color:orange\">[key_name(user)] [src.active ? "activated" : "deactivated"] shields</span>")
				...
				switch (lowertext(signal.data["status"]))
					...
					if ("sgen_actvd")
						...
						if (master && master.current_user)
							message_admins("<span style=\"color:orange\">[key_name(master.current_user)] activated shields</span>")
					...
					if ("sgen_dactvd")
						...
						if (master && master.current_user)
							message_admins("<span style=\"color:orange\">[key_name(master.current_user)] deactivated shields</span>")
