...
/datum/achievementReward/hightechpodskin
	...
	rewardActivate(var/mob/activator)
		boutput(usr, "<span style=\"color:orange\">The Kit has been dropped at your current location.</span>")
...
/proc/smugproc()
	...
	spawn(300)
		boutput(usr, "<span style=\"color:orange\">You can now be smug again! Go hog wild.</span>")
		usr.verbs += /proc/smugproc
		usr.verbs -= /proc/smugprocCD
	return
