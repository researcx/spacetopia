...
/proc/assemble_name(var/datum/abilityHolder/religious/religiousHolder)
	...
	boutput(religiousHolder.owner, "<span style=\"color:orange\">You are now a priest of [religiousHolder.god_fullname]!</span>")
	return
...
/datum/targetable/chaplain/blessWeed
	...
	cast(atom/T)
		...
		if (istype(T,/obj/item/plant/herb/cannabis/black))
			boutput(holder.owner, "<span style=\"color:orange\">You purify the toxins in [T]!</span>")
			new/obj/item/plant/herb/cannabis/spawnable(T.loc)
			qdel(T)
			return 0
		if (istype(T, /obj/item/plant/herb/cannabis/mega))
			boutput(holder.owner, "<span style=\"color:orange\">You bestow [religiousHolder.god_name]'s blessing upon [T]!</span>")
...
/datum/targetable/chaplain/chaplainDemag
	...
	cast(atom/T)
		...
		if (O.demag())
			boutput(usr, "<span style=\"color:orange\">You repair the damage to [O].</span>")
			return 0
		else
...
/datum/targetable/chaplain/sootheMachineSpirits
	...
	cast(atom/T)
		...
		usr.visible_message("<span style=\"color:orange\">[usr] places a hand on the [E] and mumbles something.</span>")
		playsound(usr.loc, "sound/effects/heavenly.ogg", 50, 1)
		spawn(30)
		E.grump = 0
		E.visible_message("<span style=\"color:orange\"><b>The [E] suddenly seems very chill!</b></span>")
