...
/datum/playing_card/griffening
	...
	effect
		...
		vuvuzela
			...
			targeting = GRIFFENING_TARGET_NONE
			card_name = "Vuvuzela"
			card_data = "When Vuvuzela is played, the owner may immediately place up to two Civilians on the field from their hand. This effect does not count against the played creature limit."
