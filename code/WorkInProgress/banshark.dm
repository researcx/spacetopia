...
//				message_admins("<span style=\"color:orange\">[usr.client.ckey] has banned [sharktarget.ckey].<br>Reason: [reason]<br>This will be removed in [sharkmins] minutes.</span>")
...
/obj/banshark/
	...
	proc/banproc()
		...
		if(sharktarget2 && sharktarget2.client)
			...
			message_admins("<span style=\"color:orange\">[caller:client.ckey] has sharkbanned [sharktarget2.ckey].<br>Reason: [sharkreason] and he couldn't escape the shark.<br>This will be removed in [sharkmins2] minutes.</span>")
	...
	proc/gibproc()
		...
		if (get_dist(src, src.sharktarget2) <= 1)
			...
			if(sharktarget2 && sharktarget2.client)
				...
				message_admins("<span style=\"color:orange\">[caller:client.ckey] has sharkgibbed [sharktarget2.ckey].</span>")
				sharktarget2.gib()
			sleep(5)
			playsound(src.loc, pick('sound/misc/burp_alien.ogg'), 50, 0)
			sleep(5)
