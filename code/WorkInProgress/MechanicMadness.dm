...
/obj/item/mechanics
	...
	verb/wipe()
		...
		mechanics.wipeIncoming()
		mechanics.wipeOutgoing()
		boutput(usr, "<span style=\"color:orange\">You disconnect [src].</span>")
		return
...
/obj/item/mechanics/cashmoney
	...
	get_desc()
		. += {"<br><span style=\"color:orange\">Collected money: [collected]<br>
...
/obj/item/mechanics/pausecomp
	...
	get_desc()
		. += "<br><span style=\"color:orange\">Current Delay: [delay]</span>"
...
/obj/item/mechanics/andcomp
	...
	get_desc()
		. += "<br><span style=\"color:orange\">Current Time Frame: [timeframe]</span>"
...
/obj/item/mechanics/wifisplit
	...
	get_desc()
		. += "<br><span style=\"color:orange\">Current Trigger Field: [mechanics.triggerSignal]</span>"
...
/obj/item/mechanics/regreplace
	...
	get_desc()
		. += "<br><span style=\"color:orange\">Current Expression: [sanitize(html_encode(expression))]</span>"
...
/obj/item/mechanics/regfind
	...
	get_desc()
		. += {"<br><span style=\"color:orange\">Current Expression: [sanitize(html_encode(expression))]<br>
...
/obj/item/mechanics/sigcheckcomp
	...
	get_desc()
		. += {"<br><span style=\"color:orange\">[not ? "Component triggers when Signal is NOT found.":"Component triggers when Signal IS found."]<br>
...
/obj/item/mechanics/sigbuilder
	...
	get_desc()
		. += {"<br><span style=\"color:orange\">Current Buffer Contents: [html_encode(sanitize(buffer))]<br>"
...
/obj/item/mechanics/relaycomp
	...
	get_desc()
		. += "<br><span style=\"color:orange\">Replace Signal is [changesig ? "on.":"off."]</span>"
...
/obj/item/mechanics/wificomp
	...
	get_desc()
		. += {"<br><span style=\"color:orange\">[send_full ? "Sending full unprocessed Signals.":"Sending only processed sendmsg and pda Message Signals."]<br>
...
/obj/item/mechanics/selectcomp
	...
	get_desc()
		. += {"<br><span style=\"color:orange\">[random ? "Sending random Signals.":"Sending selected Signals."]<br>
...
/obj/item/mechanics/togglecomp
	...
	get_desc()
		. += {"<br><span style=\"color:orange\">Currently [on ? "ON":"OFF"].<br>
...
/obj/item/mechanics/telecomp
	...
	get_desc()
		. += {"<br><span style=\"color:orange\">Current ID: [teleID].<br>
...
/obj/item/mechanics/ledcomp
	...
	get_desc()
		. += "<br><span style=\"color:orange\">Current Color: [selcolor].</span>"
...
/obj/item/mechanics/trigger/button
	...
	get_desc()
		. += "<br><span style=\"color:orange\">Current Signal: [html_encode(sanitize(mechanics.outputSignal))].</span>"
...
/obj/item/mechanics/gunholder
	...
	get_desc()
		. += "<br><span style=\"color:orange\">Current Gun: [Gun ? "[Gun] [Gun.canshoot() ? "(ready to fire)" : "(out of [istype(Gun, /obj/item/gun/energy) ? "charge)" : "ammo)"]"]" : "None"]</span>"
...
/obj/item/mechanics/gunholder/recharging
	...
	get_desc()
		...
		. += charging ? "<br><span style=\"color:orange\">Component is charging.</span>" : null
