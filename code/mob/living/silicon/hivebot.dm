...
/mob/living/silicon/hivebot/examine()
	...
	boutput(usr, text("<span style=\"color:orange\">This is [bicon(src)] <B>[src.name]</B>!</span>"))
	if (src.stat == 2)
...
/mob/living/silicon/hivebot/proc/installed_modules()
	...
	if(!src.module)
		src.pick_module()
		return
	var/dat = "<HEAD><TITLE>Modules</TITLE><META HTTP-EQUIV='Refresh' CONTENT='10'>[css_interfaces]</head><BODY><br>"
