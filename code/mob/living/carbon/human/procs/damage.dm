...
/mob/living/carbon/human/TakeDamageAccountArmor(zone, brute, burn, tox, damage_type)
	...
	if (brute + burn == 0)
		show_message("<span style='color:orange'>You have been completely protected from damage on your [z_name]!</span>")
	else if (armor_mod != 0)
		show_message("<span style='color:orange'>You have been partly protected from damage on your [z_name]!</span>")
