...
/mob/living/carbon/human/biker
	...
	attack_hand(mob/M)
		...
		if (M.a_intent in list(INTENT_HARM,INTENT_DISARM,INTENT_GRAB))
			...
			if(stat == 0)
				if (alert("Want a job?","Wrestling","Yes","No") == "Yes")
					give_objective(M, "wrestler")
...
/mob/living/carbon/human/merchant
	...
	attack_hand(mob/M)
		...
		if (M.a_intent in list(INTENT_HARM,INTENT_DISARM,INTENT_GRAB))
			...
			if(stat == 0)
				if (alert("Want a job?","Gang","Yes","No") == "Yes")
					give_objective(M, "gang leader")
// myke
...
/mob/living/carbon/human/myke
	...
	attack_hand(mob/M)
		...
		if (M.a_intent in list(INTENT_HARM,INTENT_DISARM,INTENT_GRAB))
			...
			if(stat == 0)
				if (alert("Want a job?","Changeling","Yes","No") == "Yes")
					give_objective(M, "changeling")
// waldo
...
/mob/living/carbon/human/waldo
	...
	attack_hand(mob/M)
		...
		if (M.a_intent in list(INTENT_HARM,INTENT_DISARM,INTENT_GRAB))
			...
			if(stat == 0)
				if (alert("Want a job?","Treachery","Yes","No") == "Yes")
					give_objective(M, "traitor")
