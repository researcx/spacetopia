/mob/living/carbon/wall
	...
	examine()
		...
		boutput(usr, "<span style=\"color:orange\">This is a [bicon(src)] <B>[src.name]</B>!</span>")
	...
	attack_hand(mob/user as mob)
		boutput(user, "<span style=\"color:orange\">You push the [src.name] but nothing happens!</span>")
