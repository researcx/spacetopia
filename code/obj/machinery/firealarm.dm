...
/obj/machinery/firealarm/attack_hand(mob/user as mob)
	...
	if (A.fire)
		d1 = text("<br><A href='?src=\ref[];reset=1' class='toggle-n'>Reset - Lockdown</A>", src)
	else
		d1 = text("<br><A href='?src=\ref[];alarm=1' class='toggle-off'>Alarm - Lockdown</A>", src)
	if (src.timing)
		d2 = text("<br><A href='?src=\ref[];time=0'  class='toggle-off'>Stop Time Lock</A>", src)
	else
		d2 = text("<br><A href='?src=\ref[];time=1' class='toggle-on'>Initiate Time Lock</A>", src)
	var/second = src.time % 60
	var/minute = (src.time - second) / 60
	var/dat = text("<HTML><HEAD>[css_interfaces]</head><BODY><TT><B>Fire alarm</B> []<br><HR><br>Timer System[]<BR><br>Time Left: [][]<BR><A href='?src=\ref[];tp=-30' class='timebutton'>-</A> <A href='?src=\ref[];tp=-1' class='timebutton'>-</A> <A href='?src=\ref[];tp=1' class='timebutton'>+</A> <A href='?src=\ref[];tp=30' class='timebutton'>+</A><br></TT></BODY></HTML>", d1, d2, (minute ? text("[]:", minute) : null), second, src, src, src, src)
	user << browse(dat, "window=firealarm;size=262x370")
