...
/obj/machinery/computer/communications/attack_hand(var/mob/user as mob)
	...
	user.machine = src
	var/dat = "<head><title>Communications Console</title>[css_interfaces]</head><body>"
...
/proc/cancel_call_proc(var/mob/user)
	...
	boutput(world, "<span style=\"color:orange\"><B>Alert: The shuttle is going back!</B></span>") //marker4
