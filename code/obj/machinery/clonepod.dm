...
/obj/machinery/clonepod/proc/growclone(mob/ghost as mob, var/clonename, var/datum/mind/mindref, var/datum/bioHolder/oldholder, var/datum/abilityHolder/oldabilities, var/list/traits)
	...
	boutput(src.occupant, "<span style=\"color:orange\"><b>Clone generation process initiated.</b></span>")
	boutput(src.occupant, "<span style=\"color:orange\">This will take a moment, please hold.</span>")
...
/obj/machinery/clonegrinder
	...
	emag_act(var/mob/user, var/obj/item/card/emag/E)
		if (!src.emagged)
			if (user)
				boutput(user, "<span style=\"color:orange\">You override the reclaimer's safety mechanism.</span>")
			emagged = 1
			return 1
		else
			if (user)
