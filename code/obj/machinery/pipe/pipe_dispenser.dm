...
//<A href='?src=\ref[src];make=10'>Filter Inlet<BR>
	...
	user << browse("<HEAD><TITLE>Pipe Dispenser</TITLE>[css_interfaces]</head><TT>[dat]</TT>", "window=pipedispenser")
...
"}
	...
	user << browse("<HEAD><TITLE>Disposal Pipe Dispenser</TITLE>[css_interfaces]</head><TT>[dat]</TT>", "window=pipedispenser")
	return
