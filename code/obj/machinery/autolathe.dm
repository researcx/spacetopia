...
/obj/machinery/autolathe/attack_hand(user as mob)
	...
	if (src.opened)
		...
		user << browse("<HEAD><TITLE>Autolathe Hacking</TITLE>[css_interfaces]</head>[dat]","window=autolathe_hack")
	...
	user << browse("<HEAD><TITLE>Autolathe Control Panel</TITLE>[css_interfaces]</head><TT>[dat]</TT>", "window=autolathe_regular")
