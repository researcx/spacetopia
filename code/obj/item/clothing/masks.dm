...
/obj/item/paper_mask
	...
	attackby(obj/item/W as obj, mob/user as mob)
		if (istype(W, /obj/item/pen))
			...
			if (P.font_color)
				boutput(user, "<span style=\"color:orange\">You scribble on the mask until it's filled in.</span>")
				if (P.font_color)
					src.color = P.font_color
		else if (istype(W,/obj/item/cable_coil/))
			boutput(user, "<span style=\"color:orange\">You attach the cable to the mask. Looks like you can wear it now.</span>")
