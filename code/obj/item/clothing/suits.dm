...
/obj/item/clothing/suit
	...
	var/over_hair = 0
	var/slowdown = 0 // sofia's fix for switch statement based tallies
...
/obj/item/clothing/suit/hoodie/colored
	icon_state = "hoodiec"
	item_state = "hoodiec"
	has_detail = 1
...
/obj/item/clothing/suit/bio_suit/attackby(obj/item/W, mob/user)
	...
	if(istype(W, /obj/item/clothing/suit/armor/vest))
		boutput(usr, "<span style=\"color:orange\">You attach [W] to [src].</span>")
...
/obj/item/clothing/suit/fire/attackby(obj/item/W, mob/user)
	...
	if (istype(W, /obj/item/clothing/suit/armor/vest))
		...
		boutput(user, "<span style=\"color:orange\">You attach [W] to [src].</span>")
		qdel(W)
		qdel(src)
...
/obj/item/clothing/suit/cardboard_box
	...
	attack_hand(mob/user as mob)
		if (user.a_intent == INTENT_HARM)
			user.visible_message("<span style='color:orange'>[user] taps [src].</span>",\
	...
	attackby(obj/item/W, mob/user)
		if (istype(W, /obj/item/wirecutters) || istype(W, /obj/item/scissors))
			if (src.eyeholes)
				...
				return
			user.visible_message("<span style='color:orange'>[user] begins cutting eyeholes out of [src].</span>",\
			"<span style='color:orange'>You begin cutting eyeholes out of [src].</span>")
			if (!do_after(user, 20))
				user.show_text("You were interrupted!", "red")
				return
			playsound(get_turf(src), "sound/items/Scissor.ogg", 100, 1)
			user.visible_message("<span style='color:orange'>[user] cuts eyeholes out of [src].</span>",\
			"<span style='color:orange'>You cut eyeholes out of [src].</span>")
			src.eyeholes = 1
			...
			user.visible_message("<span style='color:orange'>[user] adds [W] to [src]!</span>",\
			"<span style='color:orange'>You add [W] to [src]!</span>")
			user.u_equip(W)
			qdel(W)
			return
		else
...
/obj/item/clothing/suit/track
	name = "track suit"
	icon_state = "tracksuit"
	item_state = "tracksuit"
	has_detail = 1
	detail2_color = "#FFFFFF"
	body_parts_covered = TORSO|ARMS
	cold_resistance = 10
...
/obj/item/clothing/suit/jacket/sleeves
	icon_state = "jacketsleeves"
	item_state = "jacketsleeves"
	has_detail = 1

/obj/item/clothing/suit/jacket/job
	icon_state = "jobjacket"
	item_state = "jobjacket"
	has_detail = 1

/obj/item/clothing/suit/jacket/job/engineer
	name = "engineer jacket"
	color = "#FF6D00"
	detail_color = "#FFED00"
	detail2_color = "#FF6D00"

/obj/item/clothing/suit/jacket/job/scientist
...
/obj/item/clothing/suit/jacket/job/medic
	name = "medic jacket"
	color = "#FFFFFF"
	detail_color = "#5189be"
	detail2_color = "#FFFFFF"

/obj/item/clothing/suit/jacket/job/geneticist
	name = "geneticist jacket"
	color = "#FFFFFF"
	detail_color = "#5189be"
	detail2_color = "#8f34c6"