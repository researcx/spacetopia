...
/obj/item/clothing/shoes
	...
	attackby(obj/item/W as obj, mob/user as mob)
		if(istype(W, /obj/item/tank/air) || istype(W, /obj/item/tank/oxygen) || istype(W, /obj/item/tank/emergency_oxygen) || istype(W, /obj/item/tank/jetpack))
			...
			R.uses = uses
			boutput(user, "<span style=\"color:orange\">You haphazardly kludge together some rocket shoes.</span>")
			qdel(W)
			qdel(src)
...
/obj/item/clothing/shoes/color/lightred
	name = "light-red shoes"
	color = "#fc5900"

/obj/item/clothing/shoes/color/darkred
	name = "dark-red shoes"
	color = "#911719"
...
/obj/item/clothing/shoes/color/lightpurple
...
/obj/item/clothing/shoes/color/lightbrown
	name = "light-brown shoes"
	color = "#d6b328"

/obj/item/clothing/shoes/color/lightgreen
	name = "light-green shoes"
	color = "#63ff04"

/obj/item/clothing/shoes/color/yellowgreen
	name = "yellow-green shoes"
	color = "#d8ff00"
