...
/obj/item/cable_coil
	...
	before_stack(atom/movable/O as obj, mob/user as mob)
		user.visible_message("<span style=\"color:orange\">[user] begins coiling cable!</span>")

	after_stack(atom/movable/O as obj, mob/user as mob, var/added)
		boutput(user, "<span style=\"color:orange\">You finish coiling cable.</span>")
...
/obj/item/cable_coil/attack_self(var/mob/living/M)
	if (istype(M))
		if (M.move_laying)
			M.move_laying = null
			boutput(M, "<span style=\"color:orange\">No longer laying the cable while moving.</span>")
		else
			M.move_laying = src
			boutput(M, "<span style=\"color:orange\">Now laying cable while moving.</span>")
