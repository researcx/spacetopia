...
/obj/item/device/radio/examine()
	...
	if ((in_range(src, usr) || src.loc == usr))
		if (src.b_stat)
			usr.show_message("<span style=\"color:orange\">\the [src] can be attached and modified!</span>")
		else
			usr.show_message("<span style=\"color:orange\">\the [src] can not be modified or attached!</span>")
	if (istype(src.secure_frequencies) && src.secure_frequencies.len)
...
/obj/item/device/radio/attackby(obj/item/W as obj, mob/user as mob)
	...
	if (src.b_stat)
		user.show_message("<span style=\"color:orange\">The radio can now be attached and modified!</span>")
	else
		user.show_message("<span style=\"color:orange\">The radio can no longer be modified or attached!</span>")
...
/obj/item/device/radio/electropack/examine()
	...
	if ((in_range(src, usr) || src.loc == usr))
		if (src.e_pads)
			boutput(usr, "<span style=\"color:orange\">The electric pads are exposed!</span>")
	return*/
...
/obj/item/device/radio/electropack/attackby(obj/item/W as obj, mob/user as mob)
	...
	/*if (istype(W, /obj/item/screwdriver))
		...
		if (src.e_pads)
			user.show_message("<span style=\"color:orange\">The electric pads have been exposed!</span>")
		else
			user.show_message("<span style=\"color:orange\">The electric pads have been reinserted!</span>")
		src.add_fingerprint(user)
	else*/
...
/obj/item/device/radio/signaler/examine()
	...
	if ((in_range(src, usr) || src.loc == usr))
		if (src.b_stat)
			usr.show_message("<span style=\"color:orange\">The signaler can be attached and modified!</span>")
		else
			usr.show_message("<span style=\"color:orange\">The signaler can not be modified or attached!</span>")
	return
*/
