...
/obj/item/gun/energy/mod
	...
	examine()
		set src in view()
		boutput(usr, "<span style=\"color:orange\">Installed components:</span><br>")
		if(emitter)
			boutput(usr, "<span style=\"color:orange\">[src.emitter.name]</span>")
		if(cell)
			boutput(usr, "<span style=\"color:orange\">[src.cell.name]</span>")
		if(back)
			boutput(usr, "<span style=\"color:orange\">[src.back.name]</span>")
		if(top_rail)
			boutput(usr, "<span style=\"color:orange\">[src.top_rail.name]</span>")
		if(bottom_rail)
			boutput(usr, "<span style=\"color:orange\">[src.bottom_rail.name]</span>")
		..()
