...
/obj/item/assembly/time_ignite/attackby(obj/item/W as obj, mob/user as mob)
	...
	if (src.status)
		user.show_message("<span style=\"color:orange\">The timer is now secured!</span>", 1)
	else
		user.show_message("<span style=\"color:orange\">The timer is now unsecured!</span>", 1)
...
/obj/item/assembly/time_ignite/verb/removebeaker()
	...
	if(src.part3)
		...
		boutput(usr, "<span style=\"color:orange\">You remove the timer/igniter assembly from the beaker.</span>")
...
/obj/item/assembly/prox_ignite/attackby(obj/item/W as obj, mob/user as mob)
	...
	src.status = !( src.status )
	if (src.status)
		user.show_message("<span style=\"color:orange\">The proximity sensor is now secured! The igniter now works!</span>", 1)
	else
		user.show_message("<span style=\"color:orange\">The proximity sensor is now unsecured! The igniter will not work.</span>", 1)
	src.part2.status = src.status
	src.add_fingerprint(user)
...
/obj/item/assembly/rad_ignite/attackby(obj/item/W as obj, mob/user as mob)
	...
	src.status = !( src.status )
	if (src.status)
		user.show_message("<span style=\"color:orange\">The radio is now secured! The igniter now works!</span>", 1)
	else
		user.show_message("<span style=\"color:orange\">The radio is now unsecured! The igniter will not work.</span>", 1)
	src.part2.status = src.status
...
/obj/item/assembly/anal_ignite/attackby(obj/item/W as obj, mob/user as mob)
	...
	if (( istype(W, /obj/item/screwdriver) ))
		src.status = !( src.status )
		if (src.status)
			user.show_message("<span style=\"color:orange\">The analyzer is now secured!</span>", 1)
		else
			user.show_message("<span style=\"color:orange\">The analyzer is now unsecured!</span>", 1)
		src.part2.status = src.status
		src.add_fingerprint(user)
	return
...
/obj/item/assembly/rad_time/attackby(obj/item/W as obj, mob/user as mob)
	...
	src.status = !( src.status )
	if (src.status)
		user.show_message("<span style=\"color:orange\">The signaler is now secured!</span>", 1)
	else
		user.show_message("<span style=\"color:orange\">The signaler is now unsecured!</span>", 1)
	src.part1.b_stat = !( src.status )
	src.add_fingerprint(user)
	return
...
/obj/item/assembly/rad_prox/attackby(obj/item/W as obj, mob/user as mob)
	...
	src.status = !( src.status )
	if (src.status)
		user.show_message("<span style=\"color:orange\">The proximity sensor is now secured!</span>", 1)
	else
		user.show_message("<span style=\"color:orange\">The proximity sensor is now unsecured!</span>", 1)
	src.part1.b_stat = !( src.status )
	src.add_fingerprint(user)
	return
