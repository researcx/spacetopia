...
/obj/item/clothing/mask/cigarette
	...
	afterattack(atom/target, mob/user, flag) // copied from the propuffs
		if (istype(target, /obj/item/reagent_containers/))
			user.visible_message("<span style=\"color:orange\"><b>[user]</b> crushes up the [src] in the [target].</span>",\
			"<span style=\"color:orange\">You crush up the [src] in the [target].</span>")
