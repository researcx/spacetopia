...
/obj/item/plant/herb/cannabis/spawnable
	New()
		...
		reagents = R
		R.my_atom = src
		R.add_reagent("THC", 70)
		R.add_reagent("CBD",10)

/obj/item/plant/herb/cannabis/highcbd
	name = "yellower cannabis leaf"
	desc = "It looks more yellow. Perhaps this signifies higher CBD content?"
	icon = 'icons/obj/hydroponics/hydromisc.dmi'
	icon_state = "cbdweedleaf"
	brewable = 1
	brew_result = list("THC", "CBD")
...
/obj/item/plant/herb/cannabis/spawnable
	New()
		..()
		var/datum/reagents/R = new/datum/reagents(95)
		reagents = R
		R.my_atom = src
		R.add_reagent("THC", 70)
