...
/obj/item/spacecash
	...
	before_stack(atom/movable/O as obj, mob/user as mob)
		user.visible_message("<span style=\"color:orange\">[user] is stacking cash!</span>")

	after_stack(atom/movable/O as obj, mob/user as mob, var/added)
		boutput(user, "<span style=\"color:orange\">You finish stacking cash.</span>")
	...
	attackby(var/obj/item/I as obj, mob/user as mob)
		if (istype(I, /obj/item/spacecash) && src.amount < src.max_stack)
			...
			user.visible_message("<span style=\"color:orange\">[user] stacks some cash.</span>")
			stack_item(I)
		else
			..(I, user)
