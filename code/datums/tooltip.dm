...
/datum/tooltip
	...
	proc/show(atom/movable/thing, params = null, title = null, content = null, theme = "default", special = "none", flags = 0)
		//world.log << "Tooltip: [thing], [params], [title], [content]"
		...
		if (src.owner.mob && (istype(src.owner.mob.loc, /obj/machinery/vehicle/pod_smooth) || istype(src.owner.mob.loc, /obj/machinery/vehicle/miniputt)))
			special = "pod"
