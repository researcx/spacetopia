...
/datum/appearanceHolder
	...
	var/customization_first_color_2 = "#101010"
	var/customization_first = "None"

	var/customization_second_color = "#101010"
	var/customization_second_color_2 = "#101010"
	var/customization_second = "None"

	var/customization_third_color = "#101010"
	var/customization_third_color_2 = "#101010"
	...
	var/tail_detail_color = "#FFFFFF"

	var/ears = "None"
	var/ear_color = "#FFFFFF"
	var/ear_detail_color = "#FFFFFF"

	var/underwear = "None"
	var/u_color = "#FFFFFF"

	var/chest_detail = "None"
	var/chest_detail_color = "#FFFFFF"

	var/arm_detail = "None"
	var/arm_detail_color = "#FFFFFF"

	var/leg_detail = "None"
	var/leg_detail_color = "#FFFFFF"

	var/face_detail = "None"
	var/face_detail_color = "#FFFFFF"
	...
	proc/CopyOther(var/datum/appearanceHolder/toCopy)
		...
		customization_first_color_2 = toCopy.customization_first_color_2
		customization_first = toCopy.customization_first

		customization_second_color = toCopy.customization_second_color
		customization_second_color_2 = toCopy.customization_second_color_2
		customization_second = toCopy.customization_second

		customization_third_color = toCopy.customization_third_color
		customization_third_color_2 = toCopy.customization_third_color_2
		customization_third = toCopy.customization_third

		e_color = toCopy.e_color

		s_color = toCopy.s_color
		s_tone = toCopy.s_tone

		ears = toCopy.ears
		ear_color = toCopy.ear_color
		ear_detail_color = toCopy.ear_detail_color

		tail = toCopy.tail
		tail_color = toCopy.tail_color
		tail_detail_color = toCopy.tail_detail_color

		underwear = toCopy.underwear
		u_color = toCopy.u_color

		chest_detail = toCopy.chest_detail
		chest_detail_color = toCopy.chest_detail_color

		arm_detail = toCopy.arm_detail
		arm_detail_color = toCopy.arm_detail_color

		leg_detail = toCopy.leg_detail
		leg_detail_color = toCopy.leg_detail_color

		face_detail = toCopy.face_detail
		face_detail_color = toCopy.face_detail_color

		gender = toCopy.gender
		writtengender = toCopy.writtengender
		return
	...
	proc/ActivatePoolEffect(var/datum/bioEffect/E, var/overrideDNA = 0, var/grant_research = 1)
		...
		if(lentext(E.msgGain) > 0)
			if (E.isBad)
				...
				boutput(owner, "<span style=\"color:orange\">[E.msgGain]</span>")
		...
		if(istype(newEffect))
			...
			if(lentext(newEffect.msgGain) > 0)
				if (newEffect.isBad)
					...
					boutput(owner, "<span style=\"color:orange\">[newEffect.msgGain]</span>")
			mobAppearance.UpdateMob()
			return newEffect
	...
	proc/AddEffectInstance(var/datum/bioEffect/BE,var/do_delay = 0)
		...
		if(lentext(BE.msgGain) > 0)
			if (BE.isBad)
				...
				boutput(owner, "<span style=\"color:orange\">[BE.msgGain]</span>")
		mobAppearance.UpdateMob()
		return BE
	...
	proc/RemoveEffect(var/id)
		...
		if(D)
			...
			if(owner && lentext(D.msgLose) > 0)
				if (D.isBad)
					boutput(owner, "<span style=\"color:orange\">[D.msgLose]</span>")
				else
