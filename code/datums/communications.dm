...
/*
mob/verb/listfreq()
	boutput(world, "<span style=\"color:orange\">registered devices:</span>")
	for(var/fn in radio_controller.frequencies)
		var/datum/radio_frequency/f = radio_controller.return_frequency(fn)
		boutput(world, "<span style=\"color:orange\">[fn]</span>")
		for(var/obj/o in f.devices)
			boutput(world, "<span style=\"color:orange\">>[o]</span>")
	boutput(world, "<span style=\"color:orange\">end</span>")
*/
