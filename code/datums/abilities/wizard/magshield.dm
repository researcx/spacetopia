/datum/targetable/spell/magshield
	...
	cast()
		...
		boutput(holder.owner, "<span style=\"color:orange\"><b>You are surrounded by a magical barrier!</b></span>")
		...
		spawn(100)
			if(holder.owner && holder.owner.spellshield)
				...
				holder.owner.underlays -= shield_overlay
				shield_overlay = null
				boutput(holder.owner, "<span style=\"color:orange\"><b>Your magical barrier fades away!</b></span>")
