		...
		cheese
			...
			on_reaction(var/datum/reagents/holder)
				...
				for(var/mob/M in all_viewers(8, location))
					boutput(M, "<span style=\"color:orange\">A faint cheesy smell drifts through the air...</span>")
				return
...
/*		cocktail_sonic
		...
		cocktail_gchronic
			...
			result_amount = 2
			mix_phrase = "I suppose this is what he meant when he said he mixes the herb with some grey goose and tonic."
			mix_sound = 'sound/misc/drinkfizz.ogg'
...
// Don't forget to update Reagents-ExplosiveFire.dm too, we have duplicate code for sonic and flash powder there (Convair880).
		...
		sonic_powder
			...
			id = "sonicpowder"
			result = "sonicpowder"
			required_reagents = list("oxygen" = 1, "ammonia" = 1, "phosphorus" = 1, "stabiliser" = 1)
			result_amount = 2
		...
		sonic_boom //The "bang" part of "flashbang"
			name = "Hootingium"
			id = "sonic_boom"
			required_reagents = list("oxygen" = 1, "ammonia" = 1, "phosphorus" = 1)
			inhibitors = list("stabiliser")
			instant = 1
		...
		life
			...
			on_reaction(var/datum/reagents/holder, var/created_volume)
				...
				switch(result)
					...
					if(71 to 94)
						var/critter = pick(/obj/critter/roach,/obj/critter/pig,/obj/critter/cat,/obj/critter/mouse,/obj/critter/spacebee,/obj/critter/owl,/obj/critter/goose,/obj/critter/domestic_bee)
