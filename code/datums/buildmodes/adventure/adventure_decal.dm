/datum/adventure_submode/decal
	...
	selected()
		...
		boutput(usr, "<span style=\"color:orange\">Now placing [kind] objects in single spawn mode.</span>")
	...
	"Green Vomit" = /obj/decal/cleanable/greenpuke, "Ice (permanent)" = /obj/decal/icefloor, \
	...
	"Showcase cover" = /obj/cover/showcase, "Skeleton" = /obj/decal/skeleton,
