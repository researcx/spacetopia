/datum/adventure_submode/turf
	...
	"Ancient wall" = /turf/unsimulated/iomoon/ancient_wall, \
	...
	"Ice" = /turf/unsimulated/floor/arctic/snow/ice, "Martian floor" = /turf/simulated/martian/floor, \
	...
	selected()
		...
		boutput(usr, "<span style=\"color:orange\">Now building [kind] turfs in wide area spawn mode.</span>")
