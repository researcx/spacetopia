/datum/puzzlewizard/button
	...
	initialize()
		...
		boutput(usr, "<span style=\"color:orange\">Left click to place buttons, right click triggerables to (de)select them for automatic assignment to the buttons. Ctrl+click anywhere to finish.</span>")
