/datum/puzzlewizard/connecttool
	...
	initialize()
		...
		boutput(usr, "<span style=\"color:orange\">Left click a triggerer to select it. Left click a triggerable while a triggerer is selected to assign, right click to unassign. Ctrl+click to finish.</span>")
