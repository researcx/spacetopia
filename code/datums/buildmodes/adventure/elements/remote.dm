/datum/puzzlewizard/remotecontrol
	...
	initialize()
		...
		boutput(usr, "<span style=\"color:orange\">Left click to place remotes, right click triggerables to (de)select them for automatic assignment to the keys. Ctrl+click anywhere to finish.</span>")
