/datum/puzzlewizard/spawnloc
	...
	initialize()
		...
		qdel(adv)
		boutput(usr, "<span style=\"color:orange\">Left click to create a critter spawn location. Right click to set critter initial data in all <i>subsequent</i> critter spawners. Ctrl+click to proceed.</span>")
		boutput(usr, "<span style=\"color:orange\">NOTE: Set critter data BEFORE placing the spawn locations!</span>")
