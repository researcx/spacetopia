/datum/puzzlewizard/portal
	...
	initialize()
		...
		boutput(usr, "<span style=\"color:orange\">Select a target location with right click, then left click to place portals. Ctrl+click anywhere to finish.</span>")
	...
	build_click(var/mob/user, var/datum/buildmode_holder/holder, var/list/pa, var/atom/object)
		if (pa.Find("left"))
			...
			if (T)
				...
				target = T
				target.overlays += selection
				boutput(usr, "<span style=\"color:orange\">Target set.</span>")
