...
***********************************************************"}
	...
	click_left(atom/object, var/ctrl, var/alt, var/shift)
		if (ctrl)
			...
			boutput(usr, "<span style=\"color:orange\">Set [object]'s luminosity to 0.</span>")
		else
			...
			boutput(usr, "<span style=\"color:orange\">Set [object] to ([object.sd_ColorRed], [object.sd_ColorGreen], [object.sd_ColorBlue]):[luminosity].</span>")
	...
	click_right(atom/object, var/ctrl, var/alt, var/shift)
		if (ctrl)
			...
			boutput(usr, "<span style=\"color:orange\">Reset [object] to ([object.sd_ColorRed], [object.sd_ColorGreen], [object.sd_ColorBlue]):[object.luminosity].</span>")
			...
			boutput(usr, "<span style=\"color:orange\">Copied ([color_r], [color_g], [color_b]):[luminosity] from [object].</span>")
