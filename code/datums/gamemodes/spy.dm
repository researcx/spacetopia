...
/datum/game_mode/spy/proc/equip_leader(mob/living/carbon/human/leader)
	...
	boutput(leader, "<span style=\"color:orange\">You've been supplied with a <b>special quad-use implanter</b> in the spy starter kit in your [!isnull(the_slot) ? "[the_slot]" : "UNKNOWN"]. Use it to recruit some mindslaved henchmen!</span>")
	return
