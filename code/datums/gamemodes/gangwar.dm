...
/obj/item/spray_paint
	...
	afterattack(target as turf|obj, mob/user as mob)
		...
		boutput(user, "<span style=\"color:orange\">You have claimed this area for your gang!</span>")
...
/obj/ganglocker
	...
	attack_hand(var/mob/living/carbon/human/user as mob)
		...
		boutput(user, "<span style=\"color:orange\">You are now a member of [src.gang.gang_name]! You must wear your gang uniform.</span>")
		boutput(user, "<span style=\"color:orange\">Beware the other gangs. You can attack them if you want to, but that might start a war!</span>")
		boutput(user, "<span style=\"color:orange\">Capture turf for your gang by using spraypaint on other gangs' tags (or on any turf if the area is unclaimed).</span>")
		boutput(user, "<span style=\"color:orange\">Your gang will earn points for cash, drugs and guns on the floor in the same area as your locker.</span>")
		boutput(user, "<span style=\"color:orange\">Don't harm non-gang members unless they attack you first!</span>")
