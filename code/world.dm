...
/proc/log_deletions()
	...
	var/deletions = file("data/deletion-[time2text(world.realtime, "YYYY-MM-Month-DD-Day")].log")
	var/log = ""
	for(var/A in global.hard_deletions)
		log += "[global.hard_deletions[A]],[A] \n"
...
/world/proc/update_status()
	...
	if (config && config.server_name)
		s += "<a href=\"byond://eu.spacetopia.pw:5200/\"><big><b>[config.server_name]</b></big></a> &#8212; "

	s += " \[semi-serious roleplay | new features | updated regularly| respawns allowed | 510 compatible\]"

	s += "<br/><img src=\"http://cdn.spacetopia.pw/logo.png\"/>"
