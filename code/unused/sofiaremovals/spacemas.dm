...
/proc/santa_krampus_spawn(var/which_one = 0, var/confirmation_delay = 1200)
	...
	if (which_one == 0)
		...
		M.dnr = 1
		M.transfer_to(L)
		boutput(L, "<span style=\"color:orange\"><b>You have been respawned as Santa Claus!</b></span>")
		...
		M.dnr = 1
		M.transfer_to(L)
		boutput(L, "<span style=\"color:orange\"><b>You have been respawned as Krampus 2.0! <font color=red>Now better than ever!</font></b></span>")
...
/obj/xmastree
	name = "Spacemas tree"
	desc = "O Spacemas tree, O Spacemas tree, Much p- Huh, there's a note here with 'smoke a single weed' written on it."
	...
	proc/change_fire_state(var/burning = 0)
		if (src.on_fire && burning == 0)
			src.on_fire = 0
			src.visible_message("<span style=\"color:orange\">[src] is extinguished. Phew!</span>")
...
/mob/living/carbon/human/santa
	...
	verb
		santa_heal()
			...
			spawn(600)
				boutput(src, "<span style=\"color:orange\">You may now use your healing spell again.</span>")
				src.verbs += /mob/living/carbon/human/santa/verb/santa_heal
		...
		santa_gifts()
			...
			spawn(1200)
				boutput(src, "<span style=\"color:orange\">You may now summon gifts again.</span>")
				src.verbs += /mob/living/carbon/human/santa/verb/santa_gifts
		...
		santa_food()
			...
			spawn(800)
				boutput(src, "<span style=\"color:orange\">You may now summon snacks again.</span>")
				src.verbs += /mob/living/carbon/human/santa/verb/santa_food
		...
		santa_warmth()
			...
			spawn(800)
				boutput(src, "<span style=\"color:orange\">You may now use your warmth spell again.</span>")
				src.verbs += /mob/living/carbon/human/santa/verb/santa_warmth
		...
		santa_teleport()
			...
			spawn(300)
				boutput(src, "<span style=\"color:orange\">You may now teleport again.</span>")
				src.verbs += /mob/living/carbon/human/santa/verb/santa_teleport
...
/mob/living/carbon/human/krampus
	...
	verb
		krampus_rampage()
			...
			spawn(1800)
				boutput(src, "<span style=\"color:orange\">You feel ready to rampage again.</span>")
				src.verbs += /mob/living/carbon/human/krampus/verb/krampus_rampage
		...
		krampus_leap(var/mob/living/M as mob in oview(7))
			...
			spawn(600)
				boutput(src, "<span style=\"color:orange\">You may now leap again.</span>")
				src.verbs += /mob/living/carbon/human/krampus/verb/krampus_leap
		...
		krampus_stomp()
			...
			if(!src.stat && !src.transforming)
				...
				spawn(600)
					boutput(src, "<span style=\"color:orange\">You may now stomp again.</span>")
					src.verbs += /mob/living/carbon/human/krampus/verb/krampus_stomp
