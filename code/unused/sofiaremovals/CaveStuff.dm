...
/obj/item/runetablet
	...
	Topic(href, href_list)
		...
		if (href_list["north"])
			boutput(usr, "<span style=\"color:orange\">The rune glows softly...</span>")
			movedir = NORTH
...
/obj/item/clothing/suit/armor/ancient/equipped(var/mob/user, var/slot)
	boutput(user, "<span style=\"color:orange\">The armor plates creak oddly as you put on [src].</span>")
	...
	spawn(50)
		boutput(user, "<span style=\"color:orange\">The [src] feels like it's getting tighter. Ouch! Seems to have a lot of sharp edges inside.</span>")
