...
/client/proc/mod_list_add_ass(var/list/L, var/index) //haha
	...
	switch(class)
		...
		if ("reference picker")
			boutput(usr, "<span style=\"color:orange\">Click the mob, object or turf to use as a reference.</span>")
			var/mob/M = usr
			if (istype(M))
		...
		if ("new instance of a type")
			boutput(usr, "<span style=\"color:orange\">Type part of the path of type of thing to instantiate.</span>")
...
/datum/targetable/addtolistrefpicker
	...
	handleCast(var/atom/selected)
		boutput(usr, "<span style=\"color:orange\">Added [selected] to [target]</span>")
		target += selected
...
/datum/targetable/listrefpicker
	...
	handleCast(var/atom/selected)
		boutput(usr, "<span style=\"color:orange\">Set [target]\[[varname]\] to [selected]</span>")
...
/datum/targetable/refpicker
	...
	handleCast(var/atom/selected)
		boutput(usr, "<span style=\"color:orange\">Set [target]/var/[varname] to [selected]</span>")
	...
	global
		handleCast(var/atom/selected)
			boutput(usr, "<span style=\"color:orange\">Set [target]/var/[varname] to [selected] on all entities of the same type.</span>")
