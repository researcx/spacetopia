...
/obj/item/proc/remove_bandage(var/mob/living/carbon/human/H as mob, var/mob/user as mob)
	...
	H.tri_message("<span style=\"color:orange\"><b>[user]</b> begins removing [H == user ? "[his_or_her(H)]" : "[H]'s"] bandage.</span>",\
	user, "<span style=\"color:orange\">You begin removing [H == user ? "your" : "[H]'s"] bandage.</span>",\
	H, "<span style=\"color:orange\">[H == user ? "You begin" : "<b>[user]</b> begins"] removing your bandage.</span>")

	if (!do_mob(user, H, 50))
		user.show_text("You were interrupted!", "red")
		return 1

	H.tri_message("<span style=\"color:orange\"><b>[user]</b> removes [H == user ? "[his_or_her(H)]" : "[H]'s"] bandage.</span>",\
	user, "<span style=\"color:orange\">You remove [H == user ? "your" : "[H]'s"] bandage.</span>",\
	H, "<span style=\"color:orange\">[H == user ? "You remove" : "<b>[user]</b> removes"] your bandage.</span>")
...
/obj/item/proc/defibrillate(var/mob/living/carbon/human/patient as mob, var/mob/living/user as mob, var/emagged = 0, var/faulty = 0, var/obj/item/cell/cell = null)
	...
	if (emagged || (patient.health < 0 && !faulty) || (shockcure && !faulty) || (faulty && prob(25)))
		user.visible_message("<span style=\"color:orange\"><b>[user]</b> shocks [patient] with [src].</span>",\
		"<span style=\"color:orange\">You shock [patient] with [src].</span>")
...
/* ---------- SUTURE - HEAD ---------- */
	...
	if (surgeon.zone_sel.selecting == "head")
		if (patient.organHolder && patient.organHolder.head && patient.organHolder.head.op_stage > 0.0)
			patient.tri_message("<span style=\"color:orange\"><b>[surgeon]</b> sews the incision on [patient == surgeon ? "[his_or_her(patient)]" : "[patient]'s"] neck closed with [src].</span>",\
			surgeon, "<span style=\"color:orange\">You sew the incision on [surgeon == patient ? "your" : "[patient]'s"] neck closed with [src].</span>",\
			patient, "<span style=\"color:orange\">[patient == surgeon ? "You sew" : "<b>[surgeon]</b> sews"] the incision on your neck closed with [src].</span>")
			...
			patient.tri_message("<span style=\"color:orange\"><b>[surgeon]</b> sews the incision on [patient == surgeon ? "[his_or_her(patient)]" : "[patient]'s"] head closed with [src].</span>",\
			surgeon, "<span style=\"color:orange\">You sew the incision on [surgeon == patient ? "your" : "[patient]'s"] head closed with [src].</span>",\
			patient, "<span style=\"color:orange\">[patient == surgeon ? "You sew" : "<b>[surgeon]</b> sews"] the incision on your head closed with [src].</span>")
			...
			patient.tri_message("<span style=\"color:orange\"><b>[surgeon]</b> sews the incision in [patient == surgeon ? "[his_or_her(patient)]" : "[patient]'s"] right eye socket closed with [src].</span>",\
			surgeon, "<span style=\"color:orange\">You sew the incision in [surgeon == patient ? "your" : "[patient]'s"] right eye socket closed with [src].</span>",\
			patient, "<span style=\"color:orange\">[patient == surgeon ? "You sew" : "<b>[surgeon]</b> sews"] the incision in your right eye socket closed with [src].</span>")
			...
			patient.tri_message("<span style=\"color:orange\"><b>[surgeon]</b> sews the incision in [patient == surgeon ? "[his_or_her(patient)]" : "[patient]'s"] left eye socket closed with [src].</span>",\
			surgeon, "<span style=\"color:orange\">You sew the incision in [surgeon == patient ? "your" : "[patient]'s"] left eye socket closed with [src].</span>",\
			patient, "<span style=\"color:orange\">[patient == surgeon ? "You sew" : "<b>[surgeon]</b> sews"] the incision in your left eye socket closed with [src].</span>")
			...
			patient.tri_message("<span style=\"color:orange\"><b>[surgeon]</b> sews [patient == surgeon ? "[his_or_her(patient)]" : "[patient]'s"] wounds closed with [src].</span>",\
			surgeon, "You sew [surgeon == patient ? "your" : "[patient]'s"] wounds closed with [src].",\
			patient, "<span style=\"color:orange\">[patient == surgeon ? "You sew" : "<b>[surgeon]</b> sews"] your wounds closed with [src].</span>")
...
/* ---------- SUTURE - CHEST ---------- */
		...
		if (patient.organHolder && patient.organHolder.heart && patient.organHolder.heart.op_stage > 0.0)
			patient.tri_message("<span style=\"color:orange\"><b>[surgeon]</b> sews the incision on [patient == surgeon ? "[his_or_her(patient)]" : "[patient]'s"] chest closed with [src].</span>",\
			surgeon, "<span style=\"color:orange\">You sew the incision on [surgeon == patient ? "your" : "[patient]'s"] chest closed with [src].</span>",\
			patient, "<span style=\"color:orange\">[patient == surgeon ? "You sew" : "<b>[surgeon]</b> sews"] the incision on your chest closed with [src].</span>")
			...
			patient.tri_message("<span style=\"color:orange\"><b>[surgeon]</b> sews the incision on [patient == surgeon ? "[his_or_her(patient)]" : "[patient]'s"] butt closed with [src].</span>",\
			surgeon, "<span style=\"color:orange\">You sew the incision on [surgeon == patient ? "your" : "[patient]'s"] butt closed with [src].</span>",\
			patient, "<span style=\"color:orange\">[patient == surgeon ? "You sew" : "<b>[surgeon]</b> sews"] the incision on your butt closed with [src].</span>")
...
/* ---------- CAUTERY - HEAD ---------- */
	...
	if (surgeon.zone_sel.selecting == "head" && patient.organHolder && patient.organHolder.head && patient.organHolder.head.op_stage > 0.0)
		...
		if (quick_surgery)
			patient.tri_message("<span style=\"color:orange\"><b>[surgeon]</b> cauterizes the incision on [patient == surgeon ? "[his_or_her(patient)]" : "[patient]'s"] neck closed with [src].</span>",\
			surgeon, "<span style=\"color:orange\">You cauterize the incision on [surgeon == patient ? "your" : "[patient]'s"] neck closed with [src].</span>",\
			patient, "<span style=\"color:orange\">[patient == surgeon ? "You cauterize" : "<b>[surgeon]</b> cauterizes"] the incision on your neck closed with [src].</span>")
			...
			patient.tri_message("<span style=\"color:orange\"><b>[surgeon]</b> begins cauterizing the incision on [patient == surgeon ? "[his_or_her(patient)]" : "[patient]'s"] neck closed with [src].</span>",\
			surgeon, "<span style=\"color:orange\">You begin cauterizing the incision on [surgeon == patient ? "your" : "[patient]'s"] neck closed with [src].</span>",\
			patient, "<span style=\"color:orange\">[patient == surgeon ? "You begin" : "<b>[surgeon]</b> begins"] cauterizing incision on your neck closed with [src].</span>")
...
/* ---------- CAUTERY - BUTT ---------- */
		...
		if (quick_surgery)
			patient.tri_message("<span style=\"color:orange\"><b>[surgeon]</b> cauterizes the incision on [patient == surgeon ? "[his_or_her(patient)]" : "[patient]'s"] butt closed with [src].</span>",\
			surgeon, "<span style=\"color:orange\">You cauterize the incision on [surgeon == patient ? "your" : "[patient]'s"] butt closed with [src].</span>",\
			patient, "<span style=\"color:orange\">[patient == surgeon ? "You cauterize" : "<b>[surgeon]</b> cauterizes"] the incision on your butt closed with [src].</span>")
			...
			patient.tri_message("<span style=\"color:orange\"><b>[surgeon]</b> begins cauterizing the incision on [patient == surgeon ? "[his_or_her(patient)]" : "[patient]'s"] butt closed with [src].</span>",\
			surgeon, "<span style=\"color:orange\">You begin cauterizing the incision on [surgeon == patient ? "your" : "[patient]'s"] butt closed with [src].</span>",\
			patient, "<span style=\"color:orange\">[patient == surgeon ? "You begin" : "<b>[surgeon]</b> begins"] cauterizing incision on your butt closed with [src].</span>")
...
/* ---------- CAUTERY - BLEEDING ---------- */
		...
		if (quick_surgery)
			patient.tri_message("<span style=\"color:orange\"><b>[surgeon]</b> cauterizes [patient == surgeon ? "[his_or_her(patient)]" : "[patient]'s"] wounds closed with [src].</span>",\
			surgeon, "<span style=\"color:orange\">You cauterize [surgeon == patient ? "your" : "[patient]'s"] wounds closed with [src].</span>",\
			patient, "<span style=\"color:orange\">[patient == surgeon ? "You cauterizes" : "<b>[surgeon]</b> cauterizes"] your wounds closed with [src].</span>")

			repair_bleeding_damage(patient, 100, 10)
			return 1

		else
			patient.tri_message("<span style=\"color:orange\"><b>[surgeon]</b> begins cauterizing [patient == surgeon ? "[his_or_her(patient)]" : "[patient]'s"] wounds closed with [src].</span>",\
			surgeon, "<span style=\"color:orange\">You begin cauterizing [surgeon == patient ? "your" : "[patient]'s"] wounds closed with [src].</span>",\
			patient, "<span style=\"color:orange\">[patient == surgeon ? "You begin" : "<b>[surgeon]</b> begins"] cauterizing your wounds closed with [src].</span>")

			if (do_mob(patient, surgeon, max((patient.bleeding * 10) - (damage * 2), 0)))
				patient.tri_message("<span style=\"color:orange\"><b>[surgeon]</b> cauterizes [patient == surgeon ? "[his_or_her(patient)]" : "[patient]'s"] wounds closed with [src].</span>",\
				surgeon, "<span style=\"color:orange\">You cauterize [surgeon == patient ? "your" : "[patient]'s"] wounds closed with [src].</span>",\
				patient, "<span style=\"color:orange\">[patient == surgeon ? "You cauterize" : "<b>[surgeon]</b> cauterizes"] your wounds closed with [src].</span>")
