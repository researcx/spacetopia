/datum/tutorial
	...
	proc
		...
		ShowStep()
			...
			boutput(owner, "<span style=\"color:orange\"><b>Tutorial step #[current_step]: [T.name]</b></span>")
			boutput(owner, "<span style=\"color:orange\">[T.instructions]</span>")
		...
		Finish()
			...
			if (current_step <= steps.len)
				var/datum/tutorialStep/T = steps[current_step]
				T.TearDown()
			boutput(owner, "<span style=\"color:orange\"><b>The tutorial is finished!</b></span>")
			return 1
